...
import com.example.my_slip_keyboard.Keyboard.Key;
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public interface OnKeyboardActionListener {
         ...
         * Send a key press to the listener.
         * @param primaryCode this is the key that was pressed
		 * Called when the user swipe through on key
         */
    ...
    public KeyboardView(Context context, AttributeSet attrs) {
        this(context, attrs, context.getResources().getSystem().getIdentifier(
				"keyboardViewStyle","attr","android"));
    }
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, StyleableLoader.KeyboardView, defStyle, 0);
        ...
        for (int i = 0; i < n; i++) {
            ...
            else if(attr==StyleableLoader.KeyboardView_verticalCorrection){
                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
			}
            else if(attr==StyleableLoader.KeyboardView_keyPreviewLayout){
                previewLayout = a.getResourceId(attr, 0);
			}
            else if(attr==StyleableLoader.KeyboardView_keyPreviewOffset){
                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
			}
            else if(attr==StyleableLoader.KeyboardView_keyPreviewHeight){
                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
			}
            else if(attr==StyleableLoader.KeyboardView_keyTextSize){
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
			}
            else if(attr==StyleableLoader.KeyboardView_keyTextColor){
                mKeyTextColor = a.getColor(attr, 0xFF000000);
			}
            else if(attr==StyleableLoader.KeyboardView_labelTextSize){
//                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
                mLabelTextSize = 14;
			}
            else if(attr==StyleableLoader.KeyboardView_popupLayout){
                mPopupLayout = a.getResourceId(attr, 0);
			}
            else if(attr==StyleableLoader.KeyboardView_shadowColor){
                mShadowColor = a.getColor(attr, 0);
			}
            else if(attr==StyleableLoader.KeyboardView_shadowRadius){
                mShadowRadius = a.getFloat(attr, 0f);
			}
        }

        a = mContext.obtainStyledAttributes(StyleableLoader.Theme);
        ...
        mDisambiguateSwipe = getResources().getBoolean(
                callInternalR("bool","config_swipeDisambiguation"));
...
//                    || mAudioManager.isWiredHeadsetOn()) {
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard = (KeyboardView) mMiniKeyboardContainer.findViewById(
                        callInternalR("id","keyboardView"));
                View closeButton = mMiniKeyboardContainer.findViewById(
                        callInternalR("id","closeButton"));
                ...
                mMiniKeyboard.setOnKeyboardActionListener(new OnKeyboardActionListener() {
                    ...
                    public void onKeyThrough(int primaryCode) {
                        mKeyboardActionListener.onKeyThrough(primaryCode);
                    }
                });
	...
	private final int callInternalR(String str1, String str2)
	{
//		return mContext.getResources().getSystem().getIdentifier(str2, str1, "android");
		return Resources.getSystem().getIdentifier(str2, str1, "android");
	}
